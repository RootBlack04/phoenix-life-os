...
export default async function OverviewPage() {
  ...
  return <AppShell title="Overview">
    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6"><div className="xl:col-span-2"><LifeAreas lifeAreas={data.lifeAreas}/></div><ActiveMissions missions={data.missions}/></div>
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6"><WeeklyLineChart weeklyProgress={data.weeklyProgress}/><FocusBarChart focusTime={data.focusTime}/><TaskDonutChart taskStatus={data.taskStatus}/></div>
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6"><LanguagesPreview languages={data.languages}/><EngineeringPreview engineeringTracks={data.engineeringTracks}/></div>
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6"><div className="xl:col-span-2"><HabitsTracker habits={data.habits}/></div><MonthlyProgress monthlyProgress={data.monthlyProgress}/></div>
